#!/usr/bin/env bash
#
# Starts the three infrastructure dependencies a developer runs the hosts against — SQL Server,
# the object store and the mail server — and nothing else. The hosts themselves are meant to run
# from an IDE or `dotnet run`, whose Development settings already point at localhost.
#
