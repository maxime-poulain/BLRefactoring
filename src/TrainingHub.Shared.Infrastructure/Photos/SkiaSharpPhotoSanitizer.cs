...
/// </para>
/// </remarks>
public sealed class SkiaSharpPhotoSanitizer : IPhotoSanitizer
{
    /// <summary>
    ...
    /// <inheritdoc />
    public Result<SanitizedPhoto> Sanitize(ReadOnlyMemory<byte> content, string contentType)
    {
        ...
        // analyzer, which annotates it as never null.
        ...
        // reason about a color type per format.
        ...
        return Result<SanitizedPhoto>.Success(new SanitizedPhoto(encoded.ToArray(), contentType));
    }

    private static Result<SanitizedPhoto> Unreadable() =>
        Result<SanitizedPhoto>.Failure(
    ...
    /// </summary>
    /// <remarks>
    /// Preserved rather than normalized to one format. A trainer who uploads a PNG with a
