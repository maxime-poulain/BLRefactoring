...
public sealed class Trainer : AggregateRoot<TrainerId>
{
    ...
    public static Result<Trainer> Create(string firstname, string lastname, string email, Guid userId)
    {
    ...
    /// <param name="userId">The user ID associated with the trainer.</param>
    /// <returns>A <see cref="Result{T}"/> of type <see cref="Trainer"/>.</returns>
    public static Result<Trainer> Create(Guid id, string firstname, string lastname, string email, Guid userId)
    {
