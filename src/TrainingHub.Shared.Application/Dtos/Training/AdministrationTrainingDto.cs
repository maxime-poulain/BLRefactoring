...
/// </para>
/// <para>
/// <see cref="TrainerId"/> is here because it is the one thing a list row cannot be understood
/// without: a withheld training belongs to somebody, and the next question an administrator asks is
/// always about them.
/// </para>
/// </remarks>
