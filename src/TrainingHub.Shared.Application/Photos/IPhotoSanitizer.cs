...
/// on a phone carries GPS coordinates, and a public catalog would publish them"</em>. It also
...
/// stored — sanitizing afterwards would leave <c>TrainerPhoto.ByteSize</c> describing an upload
/// nobody kept.
/// </para>
/// </remarks>
public interface IPhotoSanitizer
{
    /// <summary>
    ...
    Result<SanitizedPhoto> Sanitize(ReadOnlyMemory<byte> content, string contentType);
}
