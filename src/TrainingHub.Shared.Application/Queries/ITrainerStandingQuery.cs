...
/// the caller's standing is <c>Suspended</c> (ADR 0053). It reads one column and materialises
...
/// They survive each other: ADR 0053 keeps the domain's rules as defence in depth precisely because
