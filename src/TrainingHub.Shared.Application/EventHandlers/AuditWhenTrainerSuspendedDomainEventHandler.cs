...
/// beside <see cref="AuditWhenTrainerNameChangedDomainEventHandler"/>.
/// <para>
...
/// </para>
/// </remarks>
public sealed class AuditWhenTrainerSuspendedDomainEventHandler(
    ILogger<AuditWhenTrainerSuspendedDomainEventHandler> logger)
