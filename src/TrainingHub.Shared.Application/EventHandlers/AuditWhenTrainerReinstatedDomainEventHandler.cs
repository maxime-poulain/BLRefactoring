...
/// <see cref="AuditWhenTrainerSuspendedDomainEventHandler"/> does.
/// </remarks>
public sealed class AuditWhenTrainerReinstatedDomainEventHandler(
    ILogger<AuditWhenTrainerReinstatedDomainEventHandler> logger)
