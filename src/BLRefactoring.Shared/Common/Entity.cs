...
/// <summary>
/// Represents an <see cref="Entity{TEntityId}"/> with a <see cref="Guid"/> as unique identifier.
/// </summary>
public abstract class Entity : Entity<Guid>
{
    // It's a good practice to have the Id generated by default.
    // This way, we don't need to worry about the Id when creating a new entity.
    // And this makes easier to work with eventual consistency.
