...
/// <summary>
/// What narrows <c>GET /Catalogue/trainings</c>, bound from the query string.
/// </summary>
/// <remarks>
/// One criterion, and it is the one ADR 0055 could not offer: a term to look for in a training's
/// title. There is no status here — an entry the catalogue serves is on offer by construction, and
...
/// </para>
/// </remarks>
public sealed class CatalogueSearchHttpRequest
{
    /// <summary>
    /// Only trainings whose title matches every word of this, or the whole catalogue when it is
    /// absent.
    /// </summary>
    /// <remarks>
