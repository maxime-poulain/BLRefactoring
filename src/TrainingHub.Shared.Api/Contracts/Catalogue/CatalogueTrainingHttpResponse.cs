...
/// <summary>
/// A row of <c>GET /Catalogue/trainings</c>: a training anybody may be shown.
/// </summary>
/// <remarks>
...
/// who they are, while a visitor is looking at a catalogue whose author pages do not exist yet.
/// Publishing every trainer's name to anybody is precisely the read this API withdrew.
/// </para>
/// </remarks>
public sealed class CatalogueTrainingHttpResponse
{
