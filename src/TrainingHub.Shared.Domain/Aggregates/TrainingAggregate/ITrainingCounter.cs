...
/// </summary>
/// <remarks>
/// The data half of the catalog-capacity rule, the same shape as
...
/// this port. The port answers the raw count rather than "is the catalog full", on purpose:
...
public interface ITrainingCounter
{
    ...
    /// </remarks>
    /// <param name="trainerId">The trainer whose catalog is being measured.</param>
