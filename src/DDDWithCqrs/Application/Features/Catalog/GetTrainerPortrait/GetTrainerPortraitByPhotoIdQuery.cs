...
/// </summary>
/// <remarks>
/// The profile's own address for the same bytes <c>GetOfferedPortraitByPhotoIdQuery</c> reaches through a
...
/// </para>
/// </remarks>
public sealed class GetTrainerPortraitByPhotoIdQuery(Guid trainerId, Guid photoId) : IQuery<TrainerPhotoDto?>
{
    /// <summary>
