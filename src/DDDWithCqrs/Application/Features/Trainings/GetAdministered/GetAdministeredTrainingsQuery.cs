...
/// </summary>
/// <remarks>
/// <c>GetMyTrainingsQuery</c> answers "the caller's own" and this one answers "everybody's", which
/// is the whole difference and the reason it needed a record before it could exist. Asking for
/// <c>Withheld</c> is what it is for: nothing else in this API can find what the administration has
/// taken down.
/// <para>
