...
/// <summary>
/// Checks <see cref="GetTrainingsByStatusQuery"/> before any handler sees it.
/// </summary>
/// <remarks>
...
/// </para>
/// </remarks>
public sealed class GetTrainingsByStatusQueryValidator : AbstractValidator<GetTrainingsByStatusQuery>
{
    /// <summary>
    /// Builds the rules.
    /// </summary>
    public GetTrainingsByStatusQueryValidator()
    {
