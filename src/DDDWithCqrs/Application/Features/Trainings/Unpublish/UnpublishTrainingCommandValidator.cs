...
/// <summary>
/// Checks <see cref="UnpublishTrainingCommand"/> before any handler sees it.
/// <para>
...
/// </para>
/// </remarks>
public sealed class UnpublishTrainingCommandValidator : AbstractValidator<UnpublishTrainingCommand>
{
    /// <summary>
    /// Builds the rules.
    /// </summary>
