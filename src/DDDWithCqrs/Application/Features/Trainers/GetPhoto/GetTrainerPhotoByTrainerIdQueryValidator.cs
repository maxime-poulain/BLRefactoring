...
/// <summary>
/// Validates <see cref="GetTrainerPhotoByTrainerIdQuery"/>.
/// </summary>
/// <remarks>
...
/// </para>
/// </remarks>
public sealed class GetTrainerPhotoByTrainerIdQueryValidator : AbstractValidator<GetTrainerPhotoByTrainerIdQuery>
{
    /// <summary>
    /// Refuses an empty identifier before it reaches the database.
    /// </summary>
    public GetTrainerPhotoByTrainerIdQueryValidator()
    {
