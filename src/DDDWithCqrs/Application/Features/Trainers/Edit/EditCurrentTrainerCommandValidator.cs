...
/// <summary>
/// Stands between <see cref="EditCurrentTrainerCommand"/> and its handler, and asks nothing.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class EditCurrentTrainerCommandValidator : AbstractValidator<EditCurrentTrainerCommand>
{
    /// <summary>
    /// Declares no rule.
    /// </summary>
    public EditCurrentTrainerCommandValidator()
    {
    }
}
