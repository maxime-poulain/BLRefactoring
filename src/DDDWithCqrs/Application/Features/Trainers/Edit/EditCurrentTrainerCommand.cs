...
/// </summary>
public sealed class EditCurrentTrainerCommand : ICommand<Result>
{
    /// <summary>
...
/// </remarks>
public sealed class EditCurrentTrainerCommandHandler(
    ITrainerRepository trainerRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
    : ICommandHandler<EditCurrentTrainerCommand, Result>
{
    /// <summary>
    /// Runs the command.
    /// </summary>
    public async ValueTask<Result> Handle(EditCurrentTrainerCommand request, CancellationToken cancellationToken)
    {
