...
/// </summary>
/// <remarks>
/// The mirror image of <c>GetMyTrainingsQuery</c>, and the contrast is the point: that one carries
/// no identity because there is none for a caller to get wrong, and this one carries no identity
/// because it is not about one. It reads across every trainer, which is what this API withdrew when
/// it deleted <c>/Trainer/all</c> and what ADR 0055 gives back to a single role.
/// <para>
...
/// </para>
/// </remarks>
public sealed class GetAdministeredTrainersQuery : IQuery<PagedResult<AdministrationTrainerDto>>
{
    /// <summary>
