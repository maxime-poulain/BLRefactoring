...
/// <summary>
/// Stands between <see cref="SetCurrentTrainerPhotoCommand"/> and its handler, and asks nothing.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class SetCurrentTrainerPhotoCommandValidator : AbstractValidator<SetCurrentTrainerPhotoCommand>
{
    /// <summary>
    /// Declares no rule.
    /// </summary>
    public SetCurrentTrainerPhotoCommandValidator()
    {
    }
}
