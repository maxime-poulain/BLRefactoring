...
/// </remarks>
public sealed class SetCurrentTrainerPhotoCommand : ICommand<Result>
{
    /// <summary>
    /// The uploaded bytes.
    /// </summary>
...
/// <summary>
/// Handles <see cref="SetCurrentTrainerPhotoCommand"/>.
/// </summary>
public sealed class SetCurrentTrainerPhotoCommandHandler(
    ...
    : ICommandHandler<SetCurrentTrainerPhotoCommand, Result>
{
    /// <inheritdoc />
    public async ValueTask<Result> Handle(SetCurrentTrainerPhotoCommand request, CancellationToken cancellationToken)
    {
