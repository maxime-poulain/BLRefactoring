...
/// <summary>
/// Checks <see cref="GetTrainersByStatusQuery"/> before any handler sees it.
/// </summary>
/// <remarks>
...
/// </para>
/// </remarks>
public sealed class GetTrainersByStatusQueryValidator : AbstractValidator<GetTrainersByStatusQuery>
{
    /// <summary>
    /// Builds the rules.
    /// </summary>
    public GetTrainersByStatusQueryValidator()
    {
