...
/// </summary>
public sealed class RemoveCurrentTrainerPhotoCommand : ICommand<Result>;

/// <summary>
/// Handles <see cref="RemoveCurrentTrainerPhotoCommand"/>.
/// </summary>
public sealed class RemoveCurrentTrainerPhotoCommandHandler(
    ITrainerRepository trainerRepository,
    ITrainerPhotoStore photoStore,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
    : ICommandHandler<RemoveCurrentTrainerPhotoCommand, Result>
{
    /// <inheritdoc />
    public async ValueTask<Result> Handle(RemoveCurrentTrainerPhotoCommand request, CancellationToken cancellationToken)
    {
