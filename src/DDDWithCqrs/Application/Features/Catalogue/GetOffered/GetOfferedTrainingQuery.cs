...
/// neighbour, and the action turns it into a 404. Telling a visitor that a training exists but has
/// been taken down is the administration's read (ADR 0055).
/// </para>
/// </remarks>
public sealed class GetOfferedTrainingQuery(Guid trainingId) : IQuery<CatalogueTrainingDetailDto?>
{
    /// <summary>
