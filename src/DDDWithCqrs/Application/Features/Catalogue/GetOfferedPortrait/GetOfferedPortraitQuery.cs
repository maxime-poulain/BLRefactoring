...
namespace TrainingHub.DDDWithCqrs.Application.Features.Catalogue.GetOfferedPortrait;
...
/// The visitor followed a catalogue entry, so the training is what they have; the photo identity is
...
/// for the reason its neighbour gives: what a visitor is not shown, they are not told about
/// (ADR 0055).
/// </para>
/// </remarks>
public sealed class GetOfferedPortraitQuery(Guid trainingId, Guid photoId) : IQuery<TrainerPhotoDto?>
{
    /// <summary>
