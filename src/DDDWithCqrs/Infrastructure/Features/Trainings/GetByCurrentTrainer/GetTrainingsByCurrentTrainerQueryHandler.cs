...
namespace TrainingHub.DDDWithCqrs.Infrastructure.Features.Trainings.GetByCurrentTrainer;
...
/// </para>
/// </remarks>
public sealed class GetTrainingsByCurrentTrainerQueryHandler(
    TrainingContext trainingContext,
    ICurrentUserService currentUserService)
    : IQueryHandler<GetTrainingsByCurrentTrainerQuery, PagedResult<TrainingDto>>
{
    /// <summary>
    /// Runs the command.
    /// </summary>
    public async ValueTask<PagedResult<TrainingDto>> Handle(
        GetTrainingsByCurrentTrainerQuery request,
