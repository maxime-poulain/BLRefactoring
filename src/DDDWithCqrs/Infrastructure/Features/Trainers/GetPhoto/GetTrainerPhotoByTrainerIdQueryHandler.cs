...
/// <summary>
/// Handles <see cref="GetTrainerPhotoByTrainerIdQuery"/>.
/// </summary>
/// <remarks>
...
/// the infrastructure.
/// </remarks>
public sealed class GetTrainerPhotoByTrainerIdQueryHandler(
    TrainingContext trainingContext,
    ITrainerPhotoStore photoStore)
    : IQueryHandler<GetTrainerPhotoByTrainerIdQuery, TrainerPhotoDto?>
{
    /// <inheritdoc />
    public async ValueTask<TrainerPhotoDto?> Handle(
        GetTrainerPhotoByTrainerIdQuery request,
