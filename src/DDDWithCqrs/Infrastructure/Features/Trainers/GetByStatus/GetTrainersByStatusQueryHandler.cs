...
namespace TrainingHub.DDDWithCqrs.Infrastructure.Features.Trainers.GetByStatus;
...
/// </para>
/// </remarks>
public sealed class GetTrainersByStatusQueryHandler(TrainingContext trainingContext)
    : IQueryHandler<GetTrainersByStatusQuery, PagedResult<AdministrationTrainerDto>>
{
    /// <summary>
    /// Runs the query.
    /// </summary>
    public async ValueTask<PagedResult<AdministrationTrainerDto>> Handle(
        GetTrainersByStatusQuery request,
