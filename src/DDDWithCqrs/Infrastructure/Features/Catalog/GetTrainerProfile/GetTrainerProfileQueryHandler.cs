...
/// </remarks>
public sealed class GetTrainerProfileQueryHandler(ICatalogDetailQuery catalogDetail)
    : IQueryHandler<GetTrainerProfileQuery, CatalogTrainerDto?>
{
    /// <summary>
    /// Runs the query.
    /// </summary>
    public async ValueTask<CatalogTrainerDto?> Handle(
        GetTrainerProfileQuery request,
