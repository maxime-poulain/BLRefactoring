...
/// </remarks>
public sealed class GetOfferedTrainingByIdQueryHandler(ICatalogDetailQuery catalogDetail)
    : IQueryHandler<GetOfferedTrainingByIdQuery, CatalogTrainingDetailDto?>
{
    /// <summary>
    /// Runs the query.
    /// </summary>
    public async ValueTask<CatalogTrainingDetailDto?> Handle(
        GetOfferedTrainingByIdQuery request,
