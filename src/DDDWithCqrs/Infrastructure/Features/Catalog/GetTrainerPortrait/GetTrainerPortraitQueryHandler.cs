...
/// second one.
/// </remarks>
public sealed class GetTrainerPortraitQueryHandler(ICatalogDetailQuery catalogDetail)
    : IQueryHandler<GetTrainerPortraitQuery, TrainerPhotoDto?>
{
    /// <summary>
    /// Runs the query.
    /// </summary>
    public async ValueTask<TrainerPhotoDto?> Handle(
        GetTrainerPortraitQuery request,
