...
/// </remarks>
public sealed class GetCatalogTopicsByTermQueryHandler(ITrainingSearchQuery trainingSearch)
    : IQueryHandler<GetCatalogTopicsByTermQuery, IReadOnlyList<TopicFacetDto>>
{
    /// <summary>
    /// Runs the query.
    /// </summary>
    public async ValueTask<IReadOnlyList<TopicFacetDto>> Handle(
        GetCatalogTopicsByTermQuery request,
