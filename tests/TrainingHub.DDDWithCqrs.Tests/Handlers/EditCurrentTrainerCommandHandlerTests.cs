...
/// <summary>
/// Behavior covered for <c>EditCurrentTrainerCommandHandler</c>.
/// </summary>
public sealed class EditCurrentTrainerCommandHandlerTests
{
    ...
    private static EditCurrentTrainerCommand Command(
