...
/// <summary>
/// Behavior covered for <c>GetOfferedTrainingByIdQueryHandler</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class GetOfferedTrainingByIdQueryHandlerTests
{
    ...
    public async Task Handle_AnIdentifier_AsksTheDetailPortForExactlyIt()
    {
        ...
        var sut = new GetOfferedTrainingByIdQueryHandler(_catalogDetail.Object);

        await sut.Handle(new GetOfferedTrainingByIdQuery(trainingId), CancellationToken.None);
    ...
    public async Task Handle_WhatThePortAnswered_HandsItBackUntouched()
    {
        ...
        var offered = await sut.Handle(
            new GetOfferedTrainingByIdQuery(Guid.CreateVersion7()),
