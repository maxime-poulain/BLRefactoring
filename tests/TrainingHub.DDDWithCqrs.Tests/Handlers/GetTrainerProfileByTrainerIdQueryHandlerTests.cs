...
/// <summary>
/// Behavior covered for <c>GetTrainerProfileByTrainerIdQueryHandler</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class GetTrainerProfileByTrainerIdQueryHandlerTests
{
    ...
    public async Task Handle_AnIdentifier_AsksTheDetailPortForExactlyIt()
    {
        ...
        var sut = new GetTrainerProfileByTrainerIdQueryHandler(_catalogDetail.Object);

        await sut.Handle(new GetTrainerProfileByTrainerIdQuery(trainerId), CancellationToken.None);
    ...
    public async Task Handle_WhatThePortAnswered_HandsItBackUntouched()
    {
        ...
        var profile = await sut.Handle(
            new GetTrainerProfileByTrainerIdQuery(Guid.CreateVersion7()),
