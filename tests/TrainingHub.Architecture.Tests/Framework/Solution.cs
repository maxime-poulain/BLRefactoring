...
using TrainingHub.Shared.Infrastructure;
...
using AuthHelper = TrainingHub.Api.TestKit.AuthHelper;
...
using LayeredApplicationSuite = TrainingHub.DDD.Application.Tests.Dtos.ProjectionsTests;
using SharedApiSuite = TrainingHub.Shared.Api.Tests.Extensions.OpenApiDocumentGenerationTests;
using CqrsApiFactory = TrainingHub.DDDWithCqrs.Api.IntegrationTests.Fixtures.ApiFactory;
using CqrsCommandDispatcher = TrainingHub.DDDWithCqrs.Infrastructure.ThirdParty.Mediator.MediatorCommandDispatcher;
using CqrsCreateTrainerCommand = TrainingHub.DDDWithCqrs.Application.Features.Trainers.Create.CreateTrainerCommand;
using CqrsTrainerController = TrainingHub.DDDWithCqrs.Api.Controller.TrainerController;
using LayeredApiFactory = TrainingHub.DDD.Api.IntegrationTests.Fixtures.ApiFactory;
using LayeredTrainerController = TrainingHub.DDD.Api.Controller.TrainerController;
using LayeredTrainerService = TrainingHub.DDD.Application.Services.TrainerServices.TrainerApplicationService;
...
/// </summary>
/// <remarks>
/// Resolved by type rather than by <c>Assembly.Load("TrainingHub.Shared.Domain")</c>, so that
