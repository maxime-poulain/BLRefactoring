...
/// </summary>
/// <remarks>
/// The twin of the layered suite's <c>CorsTests</c>, and the reason both exist: this host had no
/// CORS configuration at all — no policy, no middleware, no configuration key — while the layered
/// one had a tested policy. A test that only covers one of two hosts covers neither. The origins
/// asserted here are the ones in this API's appsettings.Development.json, which the test host
/// loads.
/// </remarks>
[Collection("Api")]
