...
/// <summary>
/// Behavior covered for <c>PublishIntegrationEventWhenTrainingEditedDomainEventHandler</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class PublishIntegrationEventWhenTrainingEditedDomainEventHandlerTests
{
    ...
    public async Task Handle_PublishesTheTrainingEditedFact_NotTheCreatedOne()
    {
        ...
        var sut = new PublishIntegrationEventWhenTrainingEditedDomainEventHandler(_publisher.Object);
