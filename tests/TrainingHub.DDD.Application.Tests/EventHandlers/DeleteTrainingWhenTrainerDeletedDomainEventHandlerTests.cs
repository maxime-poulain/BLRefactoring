...
/// <summary>
/// Behavior covered for <c>DeleteTrainingWhenTrainerDeletedDomainEventHandler</c>.
/// </summary>
public sealed class DeleteTrainingWhenTrainerDeletedDomainEventHandlerTests
{
    private readonly Mock<ITrainingRepository> _trainingRepository = new();

    private DeleteTrainingWhenTrainerDeletedDomainEventHandler CreateSut() =>
    ...
    public async Task Handle_CallsGetByTrainerIdAsync()
    {
        ...
        var domainEvent = new TrainerDeletedDomainEvent(trainer.Id, null);
        _trainingRepository
