...
/// </remarks>
public sealed class PublishIntegrationEventWhenTrainingTransferredEventHandlerTests
{
    ...
    public async Task Handle_PublishesTheTransferredFact_CarryingBothOwners()
    {
        ...
        var sut = new PublishIntegrationEventWhenTrainingTransferredEventHandler(_publisher.Object);
        await sut.Handle(
