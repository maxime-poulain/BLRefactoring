...
/// </remarks>
public sealed class PublishIntegrationEventWhenTrainerContactEmailChangedEventHandlerTests
{
    ...
    public async Task Handle_PublishesBothAddresses_EachInItsPlace()
    {
        ...
        var sut = new PublishIntegrationEventWhenTrainerContactEmailChangedEventHandler(_publisher.Object);
