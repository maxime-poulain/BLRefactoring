...
/// <summary>
/// Behavior covered for <c>PublishIntegrationEventWhenTrainerCreatedDomainEventHandler</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class PublishIntegrationEventWhenTrainerCreatedDomainEventHandlerTests
{
    ...
    public async Task Handle_PublishesTheTrainerCreatedFact_FlattenedToPrimitives()
    {
        ...
        var sut = new PublishIntegrationEventWhenTrainerCreatedDomainEventHandler(_publisher.Object);
