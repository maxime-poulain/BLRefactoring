...
/// <summary>
/// The layered host's run of the shared assertions on the single error shape. The tests live in
...
/// </summary>
[Collection("Api")]
public class ErrorFormatTests(ApiFactory factory) : ErrorFormatTest<ApiFactory>(factory);
