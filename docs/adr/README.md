...
| [0067](0067-cache-the-image-layers-without-taking-a-dependency.md) | Cache the image layers without taking a dependency | Accepted |
...
| [0065](0065-ship-every-host-as-an-image-and-build-them-in-the-pipeline.md) | Ship every host as an image, and build them in the pipeline | Accepted — amended by [0067](0067-cache-the-image-layers-without-taking-a-dependency.md): the layer cache it turned down is taken, the objection having been the dependency rather than the caching |
