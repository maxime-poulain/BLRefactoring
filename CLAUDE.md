...
2. `docs/adr/README.md` — the index of 77 architecture decision records.
3. The records relevant to what you are touching.
4. `tests/TrainingHub.Architecture.Tests/` — the same decisions as 194 executable rules. Often
