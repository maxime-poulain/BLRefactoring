...
2. `docs/adr/README.md` — the index of 25 architecture decision records.
3. The records relevant to what you are touching.
4. `tests/TrainingHub.Architecture.Tests/Rules/` — the same decisions as 110 executable rules. Often
