...
2. `docs/adr/README.md` — the index of 50 architecture decision records.
3. The records relevant to what you are touching.
4. `tests/TrainingHub.Architecture.Tests/` — the same decisions as 161 executable rules. Often
