...
2. `docs/adr/README.md` — the index of 83 architecture decision records.
3. The records relevant to what you are touching.
4. `tests/TrainingHub.Architecture.Tests/` — the same decisions as 205 executable rules. Often
